...
// which has tohave 15 chars allocated; from 0 to 14.
//
inline const void Timestamp::setval_ (  
	wchar_t val_[], const time_t & time_argument /* = time_t(0)  */
)  
{
...
L"99", (const wchar_t *)0
    ...
    errno_t rez = (localtime_s(&newtime, &aclock));  // Convert time to struct tm form 
